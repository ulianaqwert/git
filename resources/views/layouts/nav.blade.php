                        ...
                        @else
                            <div class="nav__profile">
                                ...
                                <li><a href="{{ route('basket') }}"><img style="width: 20px;" src="/image/bag.png"
                                            alt=""></a></li>
                                <li><a href="{{ route('profile') }}"><img style="width: 20px;" src="/image/user.png"
                                            alt=""></a></li>
                            </div>
                        @endguest
                    </ul>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.ajax_addAddress').on('submit', function(event) {
                // if (document.querySelector('[name="street"]').value == null) {
                //     $('.street').prepend(`<p style='color: red;'>Заполните поле</p>`)
                // }
                var id = $(this).data('id');
                event.preventDefault();
