                ...
                <div class="delivery">
                    ...
                    <div class="tab-content">
                        <div class="tab-hidden" id="tab-1">
                            <p class="address__pick-p">ВНИМАНИЕ! Доставка доступна исключительно на территории города Челябинск.</p>
                            <div class="address">
                                @foreach ($addresses as $address)
                                    <div class="address-{{$address->id}} address__item">
                                        <input type="radio" name="address" id="address-{{ $address->id }}"
                                            value="{{ $address->id }}">
                                        <label class="label-address" for="address-{{ $address->id }}">г. {{ $address->city }}, ул.
                        ...
                        <div class="tab-hidden" id="tab-2">
                            {{-- <p class="address__pick-p">ВНИМАНИЕ! Самовывоз доступен исключительно на территории города Челябинск.</p> --}}
